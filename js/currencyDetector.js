...
class CurrencyDetector {
    ...
    /**
     * Check if a 3-letter code is likely a currency code
     */
    _isLikelyCurrencyCode(code) {
        // Common non-currency 3-letter codes to filter out
        const nonCurrencyCodes = ['THE', 'AND', 'FOR', 'ARE', 'BUT', 'NOT', 'YOU', 'ALL', 'CAN', 'HER', 'WAS', 'ONE', 'OUR', 'OUT', 'DAY', 'HAD', 'HAS', 'HIS', 'HOW', 'ITS', 'MAY', 'NEW', 'NOW', 'OLD', 'SEE', 'TWO', 'WHO', 'BOY', 'DID', 'GET', 'MAN', 'OWN', 'SAY', 'SHE', 'TOO', 'USE'];
        
        return !nonCurrencyCodes.includes(code.toUpperCase());
    }
